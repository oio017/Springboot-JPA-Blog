...
var initAdditionalInfo = function(){
    $.ajax({
        type : "GET",
        url : "/api/wrapping/additionalInfo/Android",
        async : false,
        success : function(returnValue) {
            ...
            $("#additionalFileSize").text(getMessage("common.about","About")+" "+  0+" KB" )
...
var initUpload = function (){
    $('#filesForm').ajaxForm({
        ...
        beforeSubmit: function () {
            ...
            if($('#file').val()==""){
                alert(getMessage('wrapping.fileIsRequired','File은 필수 선택 요소입니다.'));
                return false;
            }
